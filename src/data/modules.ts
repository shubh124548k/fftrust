...
export const modules: ModuleDefinition[] = [
  ...
  { key: "explore", label: "Accounts", href: "/accounts", description: "Free Fire account marketplace", status: "live", iconKey: "Compass", order: 10, surface: "primary", category: "marketplace", published: true, metaDescription: "Browse canonical Free Fire account listings with honest evidence metadata, INR pricing and WhatsApp inquiry." },
  ...
  { key: "panel-seller", label: "Panel Seller", href: "/services", description: "Service marketplace", status: "live", iconKey: "Server", order: 50, surface: "services", category: "marketplace", published: true, metaDescription: "Panel Seller service marketplace — panel, top-up and care services with explicit scope and honest evidence." },
  { key: "paid-push", label: "Paid Push", href: "/paid-push", description: "CS / BR rank-push packages", status: "live", iconKey: "Trophy", order: 60, surface: "services", category: "marketplace", published: true, metaDescription: "CS Rank Push and BR Rank Push packages. No guaranteed rank, wins, anti-ban or safety. Scope and effort only." },
